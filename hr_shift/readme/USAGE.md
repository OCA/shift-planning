...
1. Go to _Shifts > Plannings_ and click on _Create_.
2. Set the year and week number for the planning and click _Save_.
3. Now click on _Generate_ to pre-create the shifts assignments for your employees.

You can start assigning shifts click on the _Shifts_ smart button where you'll go to a
kanban view with a card per employee that you can drag into the corresponding shift.
...
employee, you can do so clicking on _**Shift details**_. In the detailed kanban view
...
We can detect those issues from the general plannings view in _Shift > Plannings_.
...
do so you can either click on _**Generate planning**_ from the general plannings view in
_Shifts > Plannings_ or click on _**Copy to new planning**_ from the origin planning
form.
...
We can reset the assignments from the planning form clicking on _Regenerate shifts_.

## My shifts

All the internal users can view their assigned shifts going to _Shifts > My shifts_.
